...
> [!NOTE]
> **[SplitCord-Turkey 1.0.2 kurulum dosyası VirusTotal sonuçları](https://www.virustotal.com/gui/file-analysis/YTg5MWVmZjc0MDBhZmJjMzFiN2ExYTM2YjAyMjFmMjk6MTc4OTA0MzMzMg==)** — bu tespitlerin sebebi de yukarıda anlatılan WinDivert sınıflandırmasıdır; kurulum dosyasının kendisi arka planda çalışacak bir Windows Service kaydettiği ve sistem üzerinde değişiklik yaptığı için bazı az kullanılan, güvenilirliği düşük antivirüs motorları tarafından hatalı (false positive) olarak işaretlenebilir.
