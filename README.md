...
1. [SplitCord-Turkey-Setup-0.9.2.exe](https://github.com/cagritaskn/SplitCord-Turkey/releases/download/0.9.2/SplitCord-Turkey-Setup-0.9.2.exe) dosyasını indirin. Yeni sürümler için [Releases](https://github.com/cagritaskn/SplitCord-Turkey/releases) sayfasını takip edebilirsiniz.
