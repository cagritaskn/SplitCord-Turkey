...
1. [SplitCord-Turkey-Setup-0.9.3.exe](https://github.com/cagritaskn/SplitCord-Turkey/releases/download/0.9.3/SplitCord-Turkey-Setup-0.9.3.exe) dosyasını indirin. Yeni sürümler için [Releases](https://github.com/cagritaskn/SplitCord-Turkey/releases) sayfasını takip edebilirsiniz.
