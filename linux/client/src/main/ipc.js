...
// Windows istemcisinde bulundu, buraya da aynen uygulanıyor -- bkz. client/src/main/ipc.js'teki
// AYNI desen. KULLANICI TALEBİ: Ayarlar > DPI Aşımı > Dışlamalar — Zapret/Zapret2 aktifken
// görünen bir buton, bu ayrı themed pencereyi açıyor. openSettingsWindow ile BİREBİR AYNI
// desen (frameless, tema renkleri, kaydedilmemiş değişiklik onayı) -- SADECE farklı bir HTML
// dosyası yüklüyor. Aynı preload.js'i paylaşıyor, ayrı bir preload dosyasına gerek yok.
