...
1. **[SplitCord-Turkey-Linux-1.0.1-AMD64.AppImage](https://github.com/cagritaskn/SplitCord-Turkey/releases/download/1.0.1/SplitCord-Turkey-Linux-1.0.1-AMD64.AppImage)** dosyasını indirin. Diğer sürümler için [Releases](https://github.com/cagritaskn/SplitCord-Turkey/releases) sayfasını takip edebilirsiniz.
