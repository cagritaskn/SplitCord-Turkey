...
contextBridge.exposeInMainWorld('splitcord', {
  ...
  app: {
    ...
    requestVencordToggle: (desired) => ipcRenderer.invoke('app:request-vencord-toggle', desired),
    openVencordSettings: () => ipcRenderer.invoke('app:open-vencord-settings'),
    getVencordVersion: () => ipcRenderer.invoke('app:get-vencord-version'),
